            ...
            <a
              ...
              href={
                locale === LanguagesSupported[1]
                  ? 'https://docs.naos.one/v/zh-hans/guides/knowledge-base/integrate-knowledge-within-application'
                  : 'https://docs.naos.one/guides/knowledge-base/integrate-knowledge-within-application'
              }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - Naos`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.naos.one/images/dataset-default-icon.png'}
