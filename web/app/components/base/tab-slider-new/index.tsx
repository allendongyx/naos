      ...
      {options.map(option => (
        <div
          ...
          className={cn(
            ...
            value === option.value && 'bg-components-main-nav-nav-button-bg-active bg-gray-200 border-components-main-nav-nav-button-border shadow-xs text-primary-500 hover:bg-gray-200',
          )}
        >
