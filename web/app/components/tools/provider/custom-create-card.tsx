  ...
  return (
    <>
      {isCurrentWorkspaceManager && (
        <div className='flex flex-col col-span-1 bg-primary-600 border-[0.5px] border-black/5 rounded-xl text-white transition-all duration-200 ease-in-out cursor-pointer hover:bg-primary-500 '>
          <div className='group grow rounded-t-xl ' onClick={() => setIsShowEditCustomCollectionModal(true)}>
            <div className='shrink-0 flex items-center p-4 pb-3'>
              <div className='w-10 h-10 flex items-center justify-center bg-white text-primary-700 rounded-lg'>
