const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.naos.one/v/zh-hans/guides/knowledge-base/sync-from-website',
  ...
  otherDataSource: {
    title: '连接到其他数据源？',
    description: '目前，Naos 的知识库只有有限的数据源。向 Naos 知识库贡献数据源是帮助所有用户增强平台灵活性和强大功能的绝佳方式。我们的贡献指南使入门变得容易。请点击下面的链接了解更多信息。',
    learnMore: '了解更多信息',
  },
}
